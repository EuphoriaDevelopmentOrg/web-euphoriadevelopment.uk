  ...
  return (
    <>
      <article className="panel">
        ...
        <ul>
          <li>
            <strong>Hosted:</strong> use <code>https://nitrocraft.uk</code>{" "}
            directly.
          </li>
          <li>
            <strong>Self-hosted:</strong> use pnpm workflows, Docker Compose, or
        ...
        <div className="callout">
          <p>
            ...
            <Link to="/docs/community/nitrocraft-api">NitroCraft API Docs</Link>
            .
          </p>
        </div>
      </article>
      ...
      <article className="panel">
        ...
        <p>This runs the built Nitro output for production-style testing.</p>
      </article>
      <article className="panel">
        ...
        <div className="callout">
          <p>
            Render endpoints require native <code>canvas</code> dependencies in
            the runtime image or environment.
          </p>
        </div>
      </article>
      <article className="panel">
        ...
        <ul>
          <li>
            <code>CACHE_BACKEND</code>: <code>redis</code>, <code>memory</code>,
            or <code>none</code>
          </li>
          <li>
          ...
          <li>
            <code>SESSIONS_RATE_LIMIT</code>: outbound Mojang-session request
            limit
          </li>
          <li>
          ...
          <li>
            <code>STATUS_ALLOW_PRIVATE_TARGETS</code>: private-target probing
          </li>
          <li>
            <code>STATUS_BROWSER_*</code>: browser probe limits, timeouts, and
            feeds
          </li>
          <li>
            <code>PORT</code>, <code>BIND</code>, <code>EXTERNAL_URL</code>:
            runtime networking
          </li>
          <li>
          ...
          <li>
            <code>RETENTION_*</code>: cleanup retention and interval controls
          </li>
        </ul>
      </article>
      <article className="panel">
        ...
        <ul>
          ...
          <li>
            Release workflow: <code>.github/workflows/build-release.yml</code>
          </li>
        </ul>
        <p>
      ...
      <article className="panel">
        ...
        <ul>
          <li>
            For render failures, verify native <code>canvas</code> dependencies.
          </li>
          <li>
          ...
          <li>
            For blocked browser calls, verify <code>CORS_ORIGIN</code> and proxy
            headers.
          </li>
          <li>
