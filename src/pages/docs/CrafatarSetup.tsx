      ...
      <header className="docs-topbar">
        <div className="docs-topbar-inner">
          ...
          <nav className="docs-nav">
            ...
            <Link className="active" to="/docs/community/crafatar-setup">
              Crafatar Setup
            </Link>
        ...
        <section className="docs-layout">
          ...
          <div className="docs-content panel-grid">
            ...
            <article className="panel">
              ...
              <div className="callout">
                <p>
                  ...
                  <Link to="/docs/community/crafatar-api">
                    Crafatar API Docs
                  </Link>
                  .
                </p>
            ...
            <article className="panel">
              ...
              <p>
                The service is available at <code>http://0.0.0.0:3000</code>{" "}
                behind your proxy or domain.
              </p>
            </article>
            <article className="panel">
              ...
              <p>
                ...
                then <code>docker compose up -d</code>. The stack binds{" "}
            ...
            <article className="panel">
              ...
              <ol>
                ...
                <li>
                  Set <code>BIND=0.0.0.0</code> and <code>EXTERNAL_URL</code> to
                  your domain.
                </li>
                <li>
                ...
                <li>
                  ...
                  <code>Server running on http://</code>.
                </li>
              </ol>
              <pre>
            ...
            <article className="panel">
              ...
              <ul>
                ...
                <li>
                  <code>CACHE_LOCAL=1200</code> and{" "}
                  <code>CACHE_BROWSER=3600</code>
                </li>
                <li>
                  <code>RETENTION_ENABLED=true</code>,{" "}
              ...
              <div className="callout">
                <p>
                  ...
                  <code>rediss://</code>; an invalid protocol disables Redis
                  caching on startup.
                </p>
              </div>
            </article>
            <article className="panel">
              ...
              <p>
                Crafatar reads forwarded headers when <code>EXTERNAL_URL</code>{" "}
                is not set.
              </p>
            </article>
            <article className="panel">
              ...
              <ul>
                ...
                <li>
                  Expect <code>422</code> for invalid UUID, size, scale, or
                  default values.
                </li>
                <li>
                  For slow responses, verify Redis and Mojang-service egress.
                </li>
                <li>
                ...
                <li>
                  For full storage, tune retention and monitor inode usage.
                </li>
              </ul>
            </article>
            <article className="panel">
