      ...
      <header className="docs-topbar">
        <div className="docs-topbar-inner">
          ...
          <nav className="docs-nav">
            ...
            <Link className="active" to="/docs/community/nitrocraft-api">
              NitroCraft API
            </Link>
        ...
        <section className="docs-layout">
          ...
          <div className="docs-content panel-grid">
            <article className="panel">
              <h2>API Overview</h2>
              <p>
                <strong>NitroCraft</strong> is a full from-scratch remake built
                on Nitro and <code>minecraft-toolkit</code>, focused on
              ...
              <div className="callout">
                <p>
                  Interactive OpenAPI docs are at <code>/docs</code>; metrics
                  are at <code>/metrics</code>.
                </p>
              </div>
            ...
            <article className="panel">
              <h2>Player Lookup</h2>
              <p>
                Player routes accept a UUID or username and return
            ...
            <article className="panel">
              ...
              <ul>
                <li>
                  <code>SESSIONS_RATE_LIMIT</code> controls outbound Mojang
                ...
                <li>
                  <code>STATUS_ALLOW_PRIVATE_TARGETS</code> controls private or
                  local target probing.
                </li>
                <li>
                  <code>DEFAULT_REDIRECT_ALLOWLIST</code> controls hosts allowed
                  by <code>default=</code> redirects.
                </li>
                <li>
