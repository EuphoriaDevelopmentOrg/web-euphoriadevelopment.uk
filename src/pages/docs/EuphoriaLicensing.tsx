        ...
        <section className="docs-layout">
          ...
          <div className="docs-content panel-grid">
            <article className="panel">
              <h2>Overview</h2>
              <p>
                <strong>Euphoria Licensing</strong> is a proprietary self-hosted
                web application for license operations, product validation
                workflows, and admin management.
              </p>
              <div className="callout">
                <p>
                  A valid commercial license is required to deploy this
                  software. Redistribution, sublicensing, or source resale is
                  not allowed.
                </p>
              </div>
            ...
            <article className="panel">
              ...
              <ul>
                ...
                <li>
                  <strong>Database:</strong> PostgreSQL <code>14+</code>; 15,
                  16, or 17 recommended
                </li>
                <li>
            ...
            <article className="panel">
              ...
              <p>
                Open <code>http://SERVER_IP:3000</code> or your domain, then
                rotate seeded admin credentials immediately.
              </p>
            </article>
            <article className="panel">
              ...
              <ul>
                ...
                <li>
                  <code>HOST</code>/<code>PORT</code>: runtime bind values,
                  normally <code>0.0.0.0</code> and <code>3000</code>
                </li>
              </ul>
              <div className="callout">
                <p>
            ...
            <article className="panel">
              ...
              <ol>
                ...
                <li>
                  Run <code>pnpm db:migrate</code>, or <code>pnpm db:push</code>{" "}
                  for initial boot if required.
                </li>
                <li>
            ...
            <article className="panel">
              ...
              <p>
                Smoke test admin login, product listing, license validation
                endpoint, and logs view.
              </p>
            </article>
            <article className="panel">
              ...
              <ul>
                ...
                <li>
                  ...
                  <code>POSTGRES_URL</code>, <code>POSTGRES_*</code>, and
                  firewall access.
                </li>
                <li>
                  <strong>Build failures:</strong> confirm Node.js{" "}
                  <code>22.x</code> and pnpm <code>10.22.0</code>, then
                  reinstall dependencies.
                </li>
                <li>
                  <strong>App unreachable:</strong> check process health and
                  proxy target, normally <code>127.0.0.1:3000</code>.
                </li>
              </ul>
            </article>
            <article className="panel">
